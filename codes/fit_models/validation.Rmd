...
setwd(file.path("..", "..", "results", "flexcode"))
model_path <- getwd() 
...
colors_broad <- read.csv(file.path(bnn_path,"crossval_model_dr4_BWG_700e", "Results_DF.csv"))
colors_narrow <- read.csv(file.path(bnn_path,"crossval_model_dr4_BNWG_700e", "Results_DF.csv"))
```
